...
var RuleParser = (function () {
    ...
    RuleParser.prototype.repeat = function (value) {
        ...
        this.log('def:', def);
        var definition = function () { return _this.parse(def); };
    ...
    RuleParser.prototype.createRule = function (name, rules, options) {
        var parsedRule = this.rule(name, this.parse(rules, options), options);
...
function rule(parser, name, rules, options) {
    var rule = new RuleParser(parser, options).createRule(name, rules, options);
    return rule;
}
exports.rule = rule;
